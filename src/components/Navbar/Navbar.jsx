      ...
      <div className='flex'>
        ...
        <div className='w-9/12'>            
          <ul className='flex justify-end sm:gap-x-10 gap-x-2.5'>
            ...
            <Link to='/shop'><li className={y==='/shop' ? "font-sans font-bold text-sm text-[#262626]" : "font-sans font-normal hover:font-bold text-sm text-[#767676] hover:text-[#262626]     duration-300 ease-in-out"}>Shop</li></Link>
